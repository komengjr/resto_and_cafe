                ...
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center"><img class="ms-n2"
                        ...
                        <div>
                            ...
                            <h4 class="text-primary fw-bold mb-0">Resto <span class="text-info fw-medium">Master Bahan
                                    Baku</span></h4>
                        ...
                        <div class="col-lg-4 pt-3 pt-lg-0">
                            <div class="d-flex flex-between-center mb-3">
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0">Bahan Non Aktif</h6>
                                </div>
                                <div class="dropdown font-sans-serif btn-reveal-trigger">
                                    <button
                                        class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal"
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="mb-0">Laporan Bahan</h5>
                        </div>
                        <div class="col-auto">
                            <a class="btn btn-falcon-primary btn-sm" href="#!" data-bs-toggle="modal"
                                data-bs-target="#modal-table" id="button-add-bahan-baku">
                                <span class="fas fa-calendar-plus fs--2 me-1"></span>Add Bahan</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $datas)
                                <tr>
                                    ...
                                    <td>{{ $datas->m_bahan_type }}</td>
                                    <td>{{ $datas->m_bahan_satuan }}</td>
                                    <td>
                                        @if ($datas->m_bahan_status == 0)
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-header d-flex flex-between-center py-2 border-bottom">
                    <h5 class="mb-0">Bahan Product</h5>
                    <div class="dropdown font-sans-serif btn-reveal-trigger">
                        <button
...
@section('base.js')
    ...
    <script>
        $(document).on("click", "#button-add-bahan-baku", function(e) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                $('#menu-bahan').html(data);
            }).fail(function() {
                $('#menu-bahan').html('eror');
            });
