                ...
                <div class="row gx-0 flex-between-center">
                    <div class="col-sm-auto d-flex align-items-center"><img class="ms-n2"
                        ...
                        <div>
                            ...
                            <h4 class="text-primary fw-bold mb-0">Resto <span class="text-info fw-medium">Transaction Order</span>
                            </h4>
                            ...
                            <tr class="btn-reveal-trigger">
                                ...
                                <td class="address py-2 align-middle white-space-nowrap">
                                    ...
                                    @foreach ($menu as $menus)
                                        <p class="mb-0 text-900">{{ $menus->t_product_name }} ({{ $menus->order_qty }})</p>
                                        @php
