<div class="modal-body p-0">
    ...
    <form class="row g-3 p-4" action="{{ route('app_product_save') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-6">
            ...
            <input class="form-control" id="inputAddress" type="text" name="price" placeholder="@currency(1000000)" required/>
        </div>
        <div class="col-6">
            <label class="form-label" for="inputAddress">Discount</label>
            <input class="form-control" id="inputAddress" type="text" name="disc" placeholder="20" required/>
        </div>
        <div class="col-12">
