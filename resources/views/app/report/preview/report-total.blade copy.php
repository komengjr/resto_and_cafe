    ...
    <main>
        <div id="details" class="clearfix">
            <div id="client">
                ...
                <h2 class="name">13</h2>
                <div class="address">asdads</div>
                <div class="email">asd</div>
            </div>
            <div id="invoice">
                <h1>asd</h1>
                <div class="date">Date of Invoice: asd</div>
                <div class="date">Due Date: asd</div>
            </div>
        </div>
